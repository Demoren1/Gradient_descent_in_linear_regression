...
class Linear_Regression_Coupling:
    def __init__(self, data : np.ndarray):
        ...
        self.aggressive_steps = [self.x[1]]
    ...
    def show_graphs(self):
        ...
        tmp_theta = np.sum(np.array(self.old_thetas), axis=0) / len(self.old_thetas)

        print("predictable b =", tmp_theta[0], ", predictable k =", tmp_theta[1])
        print("b =", b, ",k =", k)
